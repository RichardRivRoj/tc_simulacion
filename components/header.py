            ...
            Div(
                ...
                Div(
                    Ul(
                        ...
                        Li(A("Simulación", href="/simulation", cls="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0")),
                        Li(A("Ayuda", href="/help", cls="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0")),
                        id="navbar-default",
